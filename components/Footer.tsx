        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4 text-sm sm:text-base">
              Leading manufacturer and supplier of high-quality sports goods. 
              We specialize in producing premium sports equipment for international markets.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-sm sm:text-base">
              <li className="flex items-center gap-2">
                <FiMail className="text-royal-gold-500" />
                <span>info@royalnexsports.com</span>
              </li>
              <li className="flex items-center gap-2">
                <FiPhone className="text-royal-gold-500" />
                <span>+92 323 7078473</span>
              </li>
